    ...
    <section ref={ref} className="relative py-20 md:py-32 overflow-hidden">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          >
            <Image src="https://t4.ftcdn.net/jpg/03/03/27/83/360_F_303278340_KmeegCDEhkLAgTwJah69wQ2nXjHwmFnw.jpg" alt="FitFaat App Dashboard" fill className="object-cover " />
          </motion.div>
        </div>
      </div>
    </section>
...
>
  <Link
    href="/feedback"
    className="bg-primary text-background px-6 py-3 rounded-full shadow-md hover:bg-primary/80 transition-all text-lg font-medium"
  >
    Add your feedback today!
  </Link>
</motion.div>
        </div>
      </section>
